...
public class fragment_popular extends android.support.v4.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //////네트워킹//////////
        Call<FeedInfo> requestMainData = service.getPartpopularInfo(user_nick,part);
   ...
   */
    ...
    public void getData(String user_nick,String part){
