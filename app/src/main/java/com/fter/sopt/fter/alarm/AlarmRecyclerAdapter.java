...
public class AlarmRecyclerAdapter extends RecyclerView.Adapter<AlarmViewHolder>{
    ...
    public void onBindViewHolder(AlarmViewHolder holder, final int position) {
        ...
        if(itemdata.get(position).readinfo==0){
            ...
            holder.title_alarm.setTextColor(context.getResources().getColor(R.color.white));
            holder.alarmText.setTextColor(context.getResources().getColor(R.color.white));
            holder.written_time_alarm.setTextColor(context.getResources().getColor(R.color.white));
        } else {
            holder.backColor_alarm.setBackgroundColor(context.getResources().getColor(white));
            holder.alarmText.setTextColor(context.getResources().getColor(R.color.black));
            holder.alarmText.setTextColor(context.getResources().getColor(R.color.black));
            holder.written_time_alarm.setTextColor(context.getResources().getColor(R.color.black));
        }
