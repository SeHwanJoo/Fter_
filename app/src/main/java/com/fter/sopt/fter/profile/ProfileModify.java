...
//    Spinner workPart;
    ...
    public static MyPageActivity activity;
...
//        workPart.set(getApplicationContext().getResources().getColor(alarmcheck));

        final Spinner dropdown = (Spinner) findViewById(R.id.mypage_modify_workpart_spinner);
