...
public class fragment_latest extends android.support.v4.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //////네트워킹//////////
        Call<FeedInfo> requestMainData = service.getPartlatestInfo(user_nick,part);
