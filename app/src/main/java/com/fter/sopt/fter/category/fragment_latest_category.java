...
public class fragment_latest_category extends android.support.v4.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public fragment_latest_category() {}
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //////네트워킹//////////
        Call<FeedInfo> requestMainData = service.getCategorlatestInfo(user_nick,part);
